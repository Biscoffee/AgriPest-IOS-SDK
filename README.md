...
pod 'AgriPestClient', :git => 'https://github.com/lukecc00/AgriPest-IOS-SDK.git', :tag => 'v1.0.78'
```
...
| **认证/用户** | 4010 | Old password is incorrect | 修改密码时旧密码校验失败 |
| **认证/用户** | 4011 | Cannot follow yourself | 尝试关注自己 |
| **认证/用户** | 4012 | Already followed this user | 已经是关注状态 |
| **认证/用户** | 4013 | You have not followed this user | 尚未关注，无法取消关注 |
| **认证/用户** | 4003 | Access denied | 权限不足 (FORBIDDEN) |
...
| **社区/帖子** | 4106 | Post content is invalid | 帖子内容不合法或太短 |
| **我的作物** | 4201 | Crop not found | 作物档案不存在 |
| **我的作物** | 4202 | Medication plan not found | 用药计划不存在 |
| **识别预警** | 4301 | Detection record not found | 识别记录不存在 |
| **识别预警** | 4302 | AI service unavailable | AI 服务不可用或超时 |
...
| **文件服务** | 4405 | Failed to read file data | 文件读取异常 |
| **消息通知** | 4501 | Message not found | 消息不存在 |
| **消息通知** | 4502 | Admin record not found | 管理员发布记录不存在 |
| **消息通知** | 4503 | Failed to send notification | 消息分发失败 |
| **搜索模块** | 4601 | Search query is too short | 搜索关键词太短 |
