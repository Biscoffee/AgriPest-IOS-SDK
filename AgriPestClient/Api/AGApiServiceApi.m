...
@interface AGApiServiceApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation AGApiServiceApi

NSString* kAGApiServiceApiErrorDomain = @"AGApiServiceApiErrorDomain";
NSInteger kAGApiServiceApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) addCommentWithId: (NSNumber*) _id
    ...
    if (_id == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kAGApiServiceApiErrorDomain code:kAGApiServiceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
