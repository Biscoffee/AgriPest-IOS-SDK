...
#import "AGResultPageCommentResponseDto.h"
#import "AGResultPagePostResponseDto.h"
...
///
///  @returns AGResultPageCommentResponseDto*
///
-(NSURLSessionTask*) getAllCommentsWithPage: (NSNumber*) page
    size: (NSNumber*) size
    completionHandler: (void (^)(AGResultPageCommentResponseDto* output, NSError* error)) handler {
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultPageCommentResponseDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultPageCommentResponseDto*)data, error);
                                }
                            }];
}
...
///  @param size  (optional, default to @10)
///
///  @returns AGResultPagePostResponseDto*
///
-(NSURLSessionTask*) getAllPostsWithTag: (NSString*) tag
    q: (NSString*) q
    page: (NSNumber*) page
    size: (NSNumber*) size
    completionHandler: (void (^)(AGResultPagePostResponseDto* output, NSError* error)) handler {
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultPagePostResponseDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultPagePostResponseDto*)data, error);
                                }
                            }];
}
