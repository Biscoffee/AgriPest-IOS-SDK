...
NSString* kAGApiErrorDomain = @"AGApiErrorDomain";
NSInteger kAGApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) changePhoneWithChangePhoneRequest: (AGChangePhoneRequest*) changePhoneRequest
    ...
    if (changePhoneRequest == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kAGApiErrorDomain code:kAGApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
