...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"_id", @"title", @"content", @"images", @"tags", @"authorId", @"authorName", @"authorAvatar", @"likeCount", @"favoriteCount", @"commentCount", @"isLiked", @"isFavorited", @"createdAt", @"updatedAt"];
