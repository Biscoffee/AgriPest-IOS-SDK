...
NSString* kAGApiServiceErrorDomain = @"AGApiServiceErrorDomain";
NSInteger kAGApiServiceMissingParamErrorCode = 234513;
...
///
///  @returns AGResultCommentResponseDto*
///
-(NSURLSessionTask*) addCommentWithId: (NSNumber*) _id
    ...
    if (commentRequest == nil) {
        NSParameterAssert(commentRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"commentRequest"] };
            NSError* error = [NSError errorWithDomain:kAGApiServiceErrorDomain code:kAGApiServiceMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/posts/{id}/comments"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"AGResultCommentResponseDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultCommentResponseDto*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) changePhoneWithChangePhoneRequest: (AGChangePhoneRequest*) changePhoneRequest
    ...
    if (changePhoneRequest == nil) {
        NSParameterAssert(changePhoneRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"changePhoneRequest"] };
            NSError* error = [NSError errorWithDomain:kAGApiServiceErrorDomain code:kAGApiServiceMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/users/me/phone"];
...
///
/// 发起多模态诊断请求
/// 上传文本描述和可选的图片，结合地理位置与天气数据返回诊断报告。
///  @param chatRequest  
///
...
-(NSURLSessionTask*) chatWithChatRequest: (AGChatRequest*) chatRequest
    ...
    if (chatRequest == nil) {
        NSParameterAssert(chatRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"chatRequest"] };
            NSError* error = [NSError errorWithDomain:kAGApiServiceErrorDomain code:kAGApiServiceMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v1/agent/chat"];
...
///  @param chatRequest  
///
///  @returns AGResultChatProfileResponse*
///
-(NSURLSessionTask*) chatProfileWithChatRequest: (AGChatRequest*) chatRequest
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v1/agent/chat/profile"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultChatProfileResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultChatProfileResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) chatStreamWithChatRequest: (AGChatRequest*) chatRequest
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v1/agent/chat/stream"];
    ...
    [headerParams addEntriesFromDictionary:self.defaultHeaders];
    // HTTP header `Accept`
    NSString *acceptHeader = [self.apiClient.sanitizer selectHeaderAccept:@[@"*/*", @"text/event-stream"]];
    if(acceptHeader.length > 0) {
        headerParams[@"Accept"] = acceptHeader;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGSseEmitter*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGSseEmitter*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) completeMultipartUploadWithMultipartUploadCompleteRequest: (AGMultipartUploadCompleteRequest*) multipartUploadCompleteRequest
    completionHandler: (void (^)(AGResultString* output, NSError* error)) handler {
    // verify the required parameter 'multipartUploadCompleteRequest' is set
    if (multipartUploadCompleteRequest == nil) {
        NSParameterAssert(multipartUploadCompleteRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"multipartUploadCompleteRequest"] };
            NSError* error = [NSError errorWithDomain:kAGApiServiceErrorDomain code:kAGApiServiceMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/files/multipart/complete"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = multipartUploadCompleteRequest;
...
///
///  @returns AGResultMyCropResponseDto*
///
-(NSURLSessionTask*) createCropWithMyCropCreateRequest: (AGMyCropCreateRequest*) myCropCreateRequest
    ...
    // verify the required parameter 'myCropCreateRequest' is set
    if (myCropCreateRequest == nil) {
        NSParameterAssert(myCropCreateRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"myCropCreateRequest"] };
            NSError* error = [NSError errorWithDomain:kAGApiServiceErrorDomain code:kAGApiServiceMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/my-crops"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultMyCropResponseDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultMyCropResponseDto*)data, error);
                                }
                            }];
}
...
///
///  @returns AGResultPostResponseDto*
///
-(NSURLSessionTask*) createPostWithPostCreateRequest: (AGPostCreateRequest*) postCreateRequest
    ...
    if (postCreateRequest == nil) {
        NSParameterAssert(postCreateRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"postCreateRequest"] };
            NSError* error = [NSError errorWithDomain:kAGApiServiceErrorDomain code:kAGApiServiceMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/posts"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultPostResponseDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultPostResponseDto*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) deleteCommentWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/admin/community/comments/{id}"];
...
-(NSURLSessionTask*) deleteCropWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/my-crops/{id}"];
...
-(NSURLSessionTask*) deletePostWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/admin/community/posts/{id}"];
...
-(NSURLSessionTask*) favoritePostWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/posts/{id}/favorite"];
...
-(NSURLSessionTask*) followUserWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/users/{id}/follow"];
...
///
///  @returns AGResultPageResultMessageResponseDto*
///
-(NSURLSessionTask*) getAlertMessagesWithPage: (NSNumber*) page
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/messages/alerts"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultPageResultMessageResponseDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultPageResultMessageResponseDto*)data, error);
                                }
                            }];
}
...
///
///  @returns AGResultPageResultCommentResponseDto*
///
-(NSURLSessionTask*) getAllCommentsWithPage: (NSNumber*) page
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/admin/community/comments"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultPageResultCommentResponseDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultPageResultCommentResponseDto*)data, error);
                                }
                            }];
}
...
///  @param size  (optional, default to @10)
///
///  @returns AGResultPageResultPostResponseDto*
///
-(NSURLSessionTask*) getAllPostsWithTag: (NSString*) tag
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/admin/community/posts"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultPageResultPostResponseDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultPageResultPostResponseDto*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getCurrentUserProfileWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultUserProfileDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultUserProfileDto*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getFavoritedPostsWithPage: (NSNumber*) page
    size: (NSNumber*) size
    completionHandler: (void (^)(AGResultPageResultPostResponseDto* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/posts/favorites"];
...
///  @returns AGResultListAgentChatHistory*
///
-(NSURLSessionTask*) getHistoryWithCompletionHandler: 
    (void (^)(AGResultListAgentChatHistory* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/v1/agent/history"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultListAgentChatHistory*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultListAgentChatHistory*)data, error);
                                }
                            }];
}
...
///  @param size  (optional, default to @10)
///
///  @returns AGResultPageResultAdminMessage*
///
-(NSURLSessionTask*) getMessageHistoryWithPage: (NSNumber*) page
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/admin/messages/history"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultPageResultAdminMessage*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultPageResultAdminMessage*)data, error);
                                }
                            }];
}
...
/// 获取我的作物列表
/// 
///  @returns AGResultListMyCropResponseDto*
///
-(NSURLSessionTask*) getMyCropsWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultListMyCropResponseDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultListMyCropResponseDto*)data, error);
                                }
                            }];
}
...
///  @param size  (optional, default to @10)
///
///  @returns AGResultMessageGroupResponseDto*
///
-(NSURLSessionTask*) getMyMessagesWithPage: (NSNumber*) page
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/messages"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultMessageGroupResponseDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultMessageGroupResponseDto*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getMyPostsWithPage: (NSNumber*) page
    size: (NSNumber*) size
    completionHandler: (void (^)(AGResultPageResultPostResponseDto* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/posts/mine"];
...
-(NSURLSessionTask*) getPostDetailWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/posts/{id}"];
...
-(NSURLSessionTask*) getSuggestionsWithQ: (NSString*) q
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/search/suggestions"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultListString*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultListString*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getTopTagsWithCompletionHandler: 
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultListTagDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultListTagDto*)data, error);
                                }
                            }];
}
...
/// 获取未读消息数
/// 
///  @returns AGResultLong*
///
-(NSURLSessionTask*) getUnreadCountWithCompletionHandler: 
    (void (^)(AGResultLong* output, NSError* error)) handler {
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/messages/unread-count"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultLong*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultLong*)data, error);
                                }
                            }];
}
...
///  @param size  (optional, default to @10)
///
///  @returns AGResultPageResultAdminUserResponseDto*
///
-(NSURLSessionTask*) getUsersWithPage: (NSNumber*) page
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultPageResultAdminUserResponseDto*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultPageResultAdminUserResponseDto*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) likePostWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/posts/{id}/like"];
...
-(NSURLSessionTask*) markAllAsReadWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/messages/read-all"];
...
-(NSURLSessionTask*) markAsReadWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/messages/{id}/read"];
...
-(NSURLSessionTask*) publishMessageWithAdminMessageCreateRequest: (AGAdminMessageCreateRequest*) adminMessageCreateRequest
    completionHandler: (void (^)(AGResultVoid* output, NSError* error)) handler {
    // verify the required parameter 'adminMessageCreateRequest' is set
    if (adminMessageCreateRequest == nil) {
        NSParameterAssert(adminMessageCreateRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"adminMessageCreateRequest"] };
            NSError* error = [NSError errorWithDomain:kAGApiServiceErrorDomain code:kAGApiServiceMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/admin/messages"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = adminMessageCreateRequest;
...
-(NSURLSessionTask*) resendMessageWithId: (NSNumber*) _id
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/admin/messages/{id}/resend"];
...
///  @param size  (optional, default to @10)
///
///  @returns AGResultSearchResultResponse*
///
-(NSURLSessionTask*) searchPostsWithQ: (NSString*) q
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/search/posts"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultSearchResultResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultSearchResultResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) startMultipartUploadWithMultipartUploadInitRequest: (AGMultipartUploadInitRequest*) multipartUploadInitRequest
    ...
    if (multipartUploadInitRequest == nil) {
        NSParameterAssert(multipartUploadInitRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"multipartUploadInitRequest"] };
            NSError* error = [NSError errorWithDomain:kAGApiServiceErrorDomain code:kAGApiServiceMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/files/multipart/init"];
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = multipartUploadInitRequest;
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"AGResultMultipartUploadInitResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((AGResultMultipartUploadInitResponse*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) updateCropWithId: (NSNumber*) _id
    ...
    // verify the required parameter 'myCropUpdateRequest' is set
    if (myCropUpdateRequest == nil) {
        NSParameterAssert(myCropUpdateRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"myCropUpdateRequest"] };
            NSError* error = [NSError errorWithDomain:kAGApiServiceErrorDomain code:kAGApiServiceMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
...
-(NSURLSessionTask*) updatePasswordWithVarNewPassword: (NSString*) varNewPassword
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/users/me/password"];
...
-(NSURLSessionTask*) updateProfileWithProfileUpdateRequest: (AGProfileUpdateRequest*) profileUpdateRequest
    ...
    if (profileUpdateRequest == nil) {
        NSParameterAssert(profileUpdateRequest);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"profileUpdateRequest"] };
            NSError* error = [NSError errorWithDomain:kAGApiServiceErrorDomain code:kAGApiServiceMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableDictionary *formParams = [[NSMutableDictionary alloc] init];
    NSMutableDictionary *localVarFiles = [[NSMutableDictionary alloc] init];
    bodyParam = profileUpdateRequest;
...
-(NSURLSessionTask*) uploadFileWithFile: (NSURL*) file
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/files/upload"];
...
-(NSURLSessionTask*) uploadFilesWithFiles: (NSArray<NSURL*>*) files
    ...
    if (files == nil) {
        ...
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"files"] };
            NSError* error = [NSError errorWithDomain:kAGApiServiceErrorDomain code:kAGApiServiceMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/files/upload/batch"];
